...
import { User, Phone, Mail, Lock, ArrowLeft, MapPin } from 'lucide-react-native';
...
type Props = NativeStackScreenProps<AuthStackParamList, 'RegisterFarmer'>;
...
export const RegisterFarmerScreen = ({ navigation }: Props) => {
  ...
  const handleRegister = async () => {
    ...
    const res = await register({
      ...
      role: 'cooperative', phone: phone.trim(), location: location.trim(),
    ...
    <ScreenWrapper scrollable padded>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <Animated.View entering={FadeInDown.duration(500)}>
          <Text style={[styles.title, { color: colors.text }]}>Cooperative Registration 🌾</Text>
          <Text style={[styles.sub, { color: colors.textSecondary }]}>Create your cooperative account</Text>
        </Animated.View>
